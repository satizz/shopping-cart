...
<form action="Electronics.jsp">
	<table >
		<tr>
		<td> <img src="img/add1.jpg" width="200px" height="300px"></td>
		<td> <p><a class="hovertext" href="Electronics.jsp" title="ELECTRONICS"><img src="img/electronics.jpg" width="600px" height="300px" style="padding:00px 0px 0px 0px;" > </a></p></td>
...
<form action="Books.jsp">
	<table>
		<tr>
		<td> <img src="img/add2.jpg"  width="200px" height="300px" ></td>
		<td> <p><a class="hovertext" href="Books.js" title="BOOKS"><img src="img/books.jpg" width="600px" height="300px" style="padding:0px 0px 0px 0px;"></a></p></td>
...
<form action="Mens.jsp">
	<table>	
		<tr>
		<td> <img src="img/add3.jpg" width="200px" height="300px"></td>
		<td> <p><a class="hovertext" href="Mens.jsp" title="MENS"><img src="img/men.jpg"  width="600px" height="300px"  style="padding:00px 0px 0px 0px;" ></a></p></td>

		</tr>
		</table>
</form>
		
<form action="Womens.jsp">
	<table>	
		<tr>
		<td> <img src="img/add4.jpg" width="200px" height="300px" ></td>
		<td> <p><a class="hovertext" href="Womens.jsp" title="WOMEN"><img src="img/women.jpg" width="600px" height="300px"  style="padding:0px 0px 0px 0px;"></a></p></td>
