...
import com.shop.service.factory.CartFactory;
...
public class BillingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			Object uid;
			uid = request.getSession().getAttribute("id");
		...
		try {
			...
			result = CartFactory.create().getProducts((Integer) uid);

			// Total bill amount
					
					total_price=CartFactory.create().getTotal((Integer) uid);
